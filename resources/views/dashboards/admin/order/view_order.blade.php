        ...
        <div class="box span12" style="margin-left: auto;">
            ...
            <div class="box-content">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($order_by_id as $order_by)
                            <tr>
                                ...
                                <td class="center"> &#8377;
                                    {{ $order_by->product_price * $order_by->product_sales_quantity }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4" style="font-size: 20px;font-weight: 521;text-align: right; color: red"> Total
                                Amount to pay</td>
                            <td><strong style="font-size: 20px; color: #007cff;">&#8377; {{ $orders->total }} </strong>
                            </td>
                        </tr>
                    </tfoot>
                </table>
