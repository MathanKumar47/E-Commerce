...
<head>
	...
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>NammaKadai Admin Dashboard</title>
...
<body>
	...
	<!-- start: Header -->
				...
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{ url('/categories/create') }}"><i class="icon-file-alt"></i>Add Category<span class="hidden-tablet"></span></a></li>
								<li><a class="submenu" href="{{ url('/categories') }}"><i class="icon-file-alt"></i>All Category<span class="hidden-tablet"></span></a></li>
							</ul>	
						</li>
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{ url('/sub-categories/create') }}"><i class="icon-file-alt"></i> Add Sub Category<span class="hidden-tablet"></span></a></li>
								<li><a class="submenu" href="{{ url('/sub-categories') }}"><i class="icon-file-alt"></i>All Sub Category<span class="hidden-tablet"></span></a></li>
							</ul>	
						</li>
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{ url('/brands/create') }}"><i class="icon-file-alt"></i>Add Brand<span class="hidden-tablet"></span></a></li>
								<li><a class="submenu" href="{{ url('/brands') }}"><i class="icon-file-alt"></i>All Brand<span class="hidden-tablet"></span></a></li>
							</ul>	
						</li>
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{ url('/products/create') }}"><i class="icon-file-alt"></i>Add Product<span class="hidden-tablet"></span></a></li>
								<li><a class="submenu" href="{{ url('/products') }}"><i class="icon-file-alt"></i>All Product<span class="hidden-tablet"></span></a></li>
							</ul>	
						</li>
		...
		@yield('dashboards.admin.content')
